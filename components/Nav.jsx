    ...
    <>
      <nav className="h-[10vh]  brightness-[1] w-full flex justify-between items-center px-[4vw] uppercase text-[white] bg-[black] ">
        ...
        <div className="elem flex gap-8 uppercase items-center text-[1.2vw] font-bold">
          ...
          <i class="ri-shopping-cart-fill px-6 py-2 bg-[orange] duration-200 font-bold text-[white] rounded-lg hover:bg-transparent border hover:border-[orange] hover:text-[#ff933b]"><button className="capitalize  text-[1.3vw] font-bold rounded-lg hover:border-[orange]">cart</button></i>
        </div>
